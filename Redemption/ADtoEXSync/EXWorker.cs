...
namespace ADtoEXSync
{
    public static class EXWorker
    {
        ...
        public static void CreateContact(ExchangeService service, Folder folder, UserPrincipal user)
        {
            ...
            Guid MyPropertySetId = new Guid("53617363-6861-5761-6c7a-656e62616368");
            ExtendedPropertyDefinition extendedPropertyDefinition = new ExtendedPropertyDefinition(MyPropertySetId, "ADSID", MapiPropertyType.String);
            contact.SetExtendedProperty(extendedPropertyDefinition, user.Sid.ToString());
